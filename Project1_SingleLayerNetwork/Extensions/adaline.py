...
class Adaline():
    ...
    def activation(self, net_in):
        '''Applies the activation function to the net input and returns the output neuron's activation. It is simply the identify function for vanilla ADALINE: f(x) = x

        Parameters: net_in: ndarray. Shape = [Num samples N,]

        Returns:  net_act. ndarray. Shape = [Num samples N,]
        '''
        net_act = net_in
        return net_act
    ...
    def predict(self, features):
        ...
        Parameters:
        features: ndarray. Shape = [Num samples N, Num features M]. Collection of input vectors.
